...
function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col justify-center items-center p-20 space-y-8 mx-auto max-w-5xl">
            <h1 className="text-3xl font-bold mt-0 mb-7 text-blue-500">Please Upload the image of the skin disease</h1>
            ...
            <Link to='/about' className="text-green-500 font-bold py-1 px-1 mt-1 mb-4 rounded border border-green-500 hover:bg-green-100 hover:cursor-pointer">Patient education portal</Link>
